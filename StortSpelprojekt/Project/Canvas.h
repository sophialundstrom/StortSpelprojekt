...
public:
	...
	void AddImage(D2D_VECTOR_2F position, const std::string name, const std::string fileName, float scale, float opacity) { images.emplace(name, Image(fileName, position, scale, opacity)); }
