...
public:
	...
	void AddText(D2D_VECTOR_2F position, const std::string name, const std::string string, UI::COLOR color, UI::TEXTFORMAT format, bool visible = true) { texts.emplace(name, new Text(to_wstr(string), position, format, UI::Inst().GetBrush(color), visible)); }
