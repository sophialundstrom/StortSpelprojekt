...
//#include <memory>
//
//class OldModel : public Drawable, public std::enable_shared_from_this<OldModel>
//{
//protected:
//	std::string name;
//
...
//	Bounds bounds;
//public:
//	OldModel(std::string file, Vector3 position = { 0.0f, 0.0f, 0.0f }, Vector3 rotation = { 0.0f, 0.0f, 0.0f }, Vector3 scale = { 1.0f, 1.0f, 1.0f });
//	OldModel(const OldModel& model);
//	virtual ~OldModel() { for (auto& mesh : meshes) delete mesh; }
//
//	virtual void Update();
//
//	//MATRIX
