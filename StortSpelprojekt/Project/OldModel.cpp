...
//
//OldModel::OldModel(std::string file, Vector3 position, Vector3 rotation, Vector3 scale)
...
//}
//
//OldModel::OldModel(const OldModel& model)
//{
...
//}
//
//void OldModel::BindToRenderGraph()
//{
//	if (HasDisplacement())
...
//}
//
//bool OldModel::HasDisplacement() const
//{
...
//}
//
//void OldModel::AddTexture(std::string file)
//{
//	for (auto& mesh : meshes)
//		Resources::AddTexture(mesh->mtllib, name, file);
//}
//
//void OldModel::AddDisplacementTexture(std::string file)
//{
//	for (auto& mesh : meshes)
//		Resources::AddDisplacementTexture(mesh->mtllib, name, file);
//}
//
//void OldModel::BindMeshBuffer(UINT index)
//{
//	if (index > meshCount)
//		return;
//
...
//}
//
//void OldModel::BindMeshTextures(UINT index, UINT startSlot, Shader shader)
//{
//	if (index > meshCount)
//		return;
//
...
//}
//
//void OldModel::BindMeshDisplacementTexture(UINT index, UINT slot, Shader shader)
//{
//	if (index > meshCount)
//		return;
//
